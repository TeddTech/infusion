...
(function ($) {
    ...
    // FLUID-9999
    fluid.defaults("fluid.tests.fluid9999root", {
        gradeNames: ["fluid.standardRelayComponent", "autoInit"],
        nickName: "nick9999",
        members: {
            initialModelValue: 1
        ...
        model: {
            rootValue: "{that}.initialModelValue"
        },
        components: {
            level1: {
                type: "fluid.standardRelayComponent",
                options: {
                    components: {
                        level2: {
                            ...
                            options: {
                                model: {
                                    level2Value: "{nick9999}.model.rootValue"
                                }
                            }
                        }
                    }
    ...
    jqUnit.test("FLUID-9999: The model relay to the grandchild target", function () {
        var that = fluid.tests.fluid9999root();
        console.log(that);
        jqUnit.assertEquals("The initial model value has been set", that.initialModelValue, that.level1.level2.model.level2Value);
        that.applier.change("rootValue", 2);
        jqUnit.assertEquals("The new model value has been set", 2, that.level1.level2.model.level2Value);
    });
